...
parser.add_argument('-s', '--size', metavar='', type=int, required=False, help='dot size')
parser.add_argument('-d', '--distance', metavar='', type=int, required=False, help='distance between each dot')
